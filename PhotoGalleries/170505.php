...
<title>Insta-Memories | Mr & Mrs Engel's Wedding</title>
  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "Anissa & David Engel's Wedding";
		$event_date = "05.05.2017";
		$fid = 37;
		
		//Zip Download
		$zip_name = "MrMrsEngel.zip";
		$download_zip = "/images/2017.05.05/";
		
		//Download Image
		$download_img = "/images/2017.05.05/gallery/HD/";
