...
<title>Insta-Memories | Jasmine's Quinceañ佩佩倥鱇鹿title>
  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "Jasmine's Quinceañera";
		$event_date = "01.21.2017";
		$fid = 34;
		
		//Zip Download
		$zip_name = "Jasmine15.zip";
		$download_zip = "/images/2017.01.21/";
		
		//Download Image
		$download_img = "/images/2017.01.21/gallery/HD/";
