...
<body>
    ...
    <main>
        ...
        <section class="vl-hero-area vl-hero-area-4 vl-hero-bg p-relative z-index-1 fix pt-190 pb-70" style="background-image: url(assets/img/banner/vl-hero-bg-4.1.png);">
            <div class="container">
                <div class="row">
                        ...
                        <div class="vl-hero-img p-relative">
                            <div class="vl-hero-shape-4">
                                <div class="vl-shape-1">
                                    <img src="assets/img/icons/vl-emoji-4.1.svg" alt="">
                                </div>
                            ...
                            <div class="vl-hero-fan">
                                <img class="w-100" src="assets/img/icons/vl-fan.svg" alt="">
                            </div>
                            <div class="vl-hero-img-4">
                                <img class="w-100" src="assets/img/banner/vl-hero-4.1.png" alt="">
                            </div>
                            <div class="vl-hero-img-4-content">
                                ...
                                <div class="vl-hero-img-4-grup">
                                    <div class="vl-hero-img-4-grup-img">
                                        <img src="assets/img/banner/vl-hero-group.png" alt="">
                                    </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-imgs vl-about-imgs-3 p-relative z-index-1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="800">
                            ...
                            <div class="vl-about-sm-2 d-none d-md-block">
                                <img src="assets/img/about/vl-about-top-sm-4.2.png" alt="">
                            </div>

                            <div class="vl-about-poligon-shap p-relative z-index-1 fl-right">
                                <img src="assets/img/icons/vl-about-poliogon.svg" alt="">
                        ...
                        <div class="vl-about-content-4 aos-init aos-animate" data-aos="fade-left" data-aos-duration="800">
                            <div class="vl-section-title-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="vl-about-icon-box-4 br-8 mb-30">
                                            <div class="vl-about-icon-box-4-icon4">
                                                <span><img src="assets/img/icons/vl-ser-ic-4.1.svg" alt=""></span>
                                            </div>
                                            <div class="vl-about-icon-box-4-content4">
                                                <h3 class="vl-about-icon-box-4-title pt-20 pb-16"><a href="service-single.php">Excellence in Solution</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="vl-about-icon-box-4 br-8 mb-30">
                                            <div class="vl-about-icon-box-4-icon4">
                                                <span><img src="assets/img/icons/vl-ser-ic-4.2.svg" alt=""></span>
                                            </div>
                                            <div class="vl-about-icon-box-4-content4">
                                                <h3 class="vl-about-icon-box-4-title pt-20 pb-16"><a href="service-single.php">Difference We Deliver</a></h3>
                            ...
                            <div class="vl-aboutbtn">
                                <div class="vl-herobtn vl-aboutbtn vl-upper">
                                    <a href="about.php" class="theme-btn theme-btn2">About us<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                        <div class="vl-service-icon-box-4 p-relative z-index-1 fix br-8">
                            <div class="vl-service-icon-box-4-icon4">
                                <span><img src="assets/img/icons/vl-ser-ic-4.11.svg" alt=""></span>
                            </div>
                            <div class="vl-service-icon-box-4-content4">
                                <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="service-single.php">Excellence in Solution</a></h3>
                                ...
                                <a href="service-single.php" class="readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                        <div class="vl-service-icon-box-4 p-relative z-index-1 fix br-8">
                            <div class="vl-service-icon-box-4-icon4">
                                <span><img src="assets/img/icons/vl-ser-ic-4.22.svg" alt=""></span>
                            </div>
                            <div class="vl-service-icon-box-4-content4">
                                <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="service-single.php">IT Infrastcture Management</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200">
                        <div class="vl-service-icon-box-4 p-relative z-index-1 fix br-8">
                            <div class="vl-service-icon-box-4-icon4">
                                <span><img src="assets/img/icons/vl-ser-ic-4.3.svg" alt=""></span>
                            </div>
                            <div class="vl-service-icon-box-4-content4">
                                <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="service-single.php">Cybersecurity Services</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1300">
                        <div class="vl-service-icon-box-4 p-relative z-index-1 fix br-8">
                            <div class="vl-service-icon-box-4-icon4">
                                <span><img src="assets/img/icons/vl-ser-ic-4.4.svg" alt=""></span>
                            </div>
                            <div class="vl-service-icon-box-4-content4">
                                <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="service-single.php">IT Consulting & Strategy</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1400">
                        <div class="vl-service-icon-box-4 p-relative z-index-1 fix br-8">
                            <div class="vl-service-icon-box-4-icon4">
                                <span><img src="assets/img/icons/vl-ser-ic-4.5.svg" alt=""></span>
                            </div>
                            <div class="vl-service-icon-box-4-content4">
                                <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="service-single.php">Managed IT Services</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
                        <div class="vl-service-icon-box-4 p-relative z-index-1 fix br-8">
                            <div class="vl-service-icon-box-4-icon4">
                                <span><img src="assets/img/icons/vl-ser-ic-4.6.svg" alt=""></span>
                            </div>
                            <div class="vl-service-icon-box-4-content4">
                                <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="service-single.php">Network Design & Security</a></h3>
                ...
                <div id="gallery1" class="owl-carousel owl-theme">
                    ...
                    <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
                        <div class="vl-gallery-testimonial-2-image">
                            <img class="w-100" src="assets/img/studies/vl-studies-2.1.png" alt="">
                        </div>
                        <div class="vl-gallery-testimonial-2-con">
                            <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single.php">Efficiency Managed IT Services</a></h3>
                        </div>
                        <div class="vl-gallery-poligon">
                            <h3><a href="case-studies-single.php">Read More</a></h3>
                            <a href="case-studies-single.php"><span><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                    ...
                    <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
                        <div class="vl-gallery-testimonial-2-image">
                            <img class="w-100" src="assets/img/studies/vl-studies-2.2.png" alt="">
                        </div>
                        <div class="vl-gallery-testimonial-2-con">
                            <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single.php">Building Resilient Networks </a></h3>
                        </div>
                        <div class="vl-gallery-poligon">
                            <h3><a href="case-studies-single.php">Read More</a></h3>
                            <a href="case-studies-single.php"><span><i class="fa-regular fa-arrow-right"></i></span></a>
                    ...
                    <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
                        <div class="vl-gallery-testimonial-2-image">
                            <img class="w-100" src="assets/img/studies/vl-studies-2.3.png" alt="">
                        </div>
                        <div class="vl-gallery-testimonial-2-con">
                            <h3 class="vl-gallery-testimonial-2-title"><a href="case-studies-single.php">Seamless Cloud Migration</a></h3>
                        </div>
                        <div class="vl-gallery-poligon">
                            <h3><a href="case-studies-single.php">Read More</a></h3>
                            <a href="case-studies-single.php"><span><i class="fa-regular fa-arrow-right"></i></span></a>
                        ...
                        <div class="vl-testimonial-2 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-testimonialbtn-2">
                                <div class="vl-herobtn">
                                    <a href="testimonial.php" class="theme-btn vl-upper">Read more reviews<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="vl-testimonial-box vl-testimonial-box-4 p-relative br-8">
                                ...
                                <div class="vl-testimonial-box-auth p-relative">
                                    ...
                                    <div class="vl-testimonial-box-quote">
                                        <img src="assets/img/icons/vl-testimonial-q2.svg" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-pricing-box p-relative z-index-1 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            ...
                            <div class="vl-pricing-box-btn mt-12">
                                <div class="vl-herobtn vl-aboutbtn vl-upper">
                                    <a href="pricing-plan.php" class="theme-btn theme-btn2">choose a plan<span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="test" class="owl-carousel owl-theme">
                        <div class="vl-team-sin">
                            <div class="vl-team-thumb">
                                <div class="vl-team-shape">
                                    <img src="assets/img/icons/vl-tean-shap1.svg" alt="">
                                </div>
                                <img class="w-100" src="assets/img/team/vl-team-4.1.png" alt="">
                            ...
                            <div class="vl-team-content">
                                <h4 class="title"><a href="team.php">Kendra Cremin</a></h4>
                        ...
                        <div class="vl-team-sin">
                            <div class="vl-team-thumb">
                                ...
                                <img class="w-100" src="assets/img/team/vl-team-4.2.png" alt="">
                                <div class="vl-tem-social">
                                    <ul>
                                        <li><a href="#"><span><i class="fa-brands fa-facebook-f"></i></span></a></li>
                                        <li><a href="#"><span><i class="fa-brands fa-linkedin-in"></i></span></a></li>
                            ...
                            <div class="vl-team-content">
                                <h4 class="title"><a href="team.php">Dennis Jacobson</a></h4>
                        ...
                        <div class="vl-team-sin">
                            <div class="vl-team-thumb">
                                ...
                                <img class="w-100" src="assets/img/team/vl-team-4.3.png" alt="">
                                <div class="vl-tem-social">
                                    <ul>
                                        <li><a href="#"><span><i class="fa-brands fa-facebook-f"></i></span></a></li>
                                        <li><a href="#"><span><i class="fa-brands fa-linkedin-in"></i></span></a></li>
                            ...
                            <div class="vl-team-content">
                                <h4 class="title"><a href="team.php">Patricia Wilkinson</a></h4>
                        ...
                        <div class="vl-team-sin">
                            <div class="vl-team-thumb">
                                ...
                                <img class="w-100" src="assets/img/team/vl-team-4.4.png" alt="">
                                <div class="vl-tem-social">
                                    <ul>
                                        <li><a href="#"><span><i class="fa-brands fa-facebook-f"></i></span></a></li>
                                        <li><a href="#"><span><i class="fa-brands fa-linkedin-in"></i></span></a></li>
                            ...
                            <div class="vl-team-content">
                                <h4 class="title"><a href="team.php">Jack Williamson</a></h4>
                                <span>Digital Marketer</span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-single-blog-img vl-single-blog-img-4 br-8 fix p-relative">
                                <a href="blog-single.php"><img class="w-100" src="assets/img/blog/vl-blog-4.1.png" alt=""></a>
                            </div>
                            <div class="vl-single-blog-4 p-relative z-index-1">
                                <div class="vl-single-blog-right-arow">
                                    <a href="blog-single.php"><i class="fa-light fa-arrow-right"></i></a>
                                </div>
                                ...
                                <div class="vl-single-blog-content vl-single-blog-content-4 p-relative z-index-1">
                                    <h3 class="vl-single-blog-title vl-single-blog-title-4 pt-18 pb-12"><a href="blog-single.php">Your Trusted Partner in Technology Transformation</a></h3>
                                    ...
                                    <a href="blog-single.php" class="vl-readmore redmore">Read More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="900">
                            <div class="vl-single-blog-img vl-single-blog-img-4 br-8 fix p-relative">
                                <a href="blog-single.php"><img class="w-100" src="assets/img/blog/vl-blog-4.2.png" alt=""></a>
                            </div>
                            <div class="vl-single-blog-4 p-relative z-index-1">
                                <div class="vl-single-blog-right-arow">
                                ...
                                <div class="vl-single-blog-content vl-single-blog-content-4 p-relative z-index-1">
                                    <h3 class="vl-single-blog-title vl-single-blog-title-4 pt-18 pb-12"><a href="blog-single.php">The Latest in Tech: News, Tips, and Insights</a></h3>
