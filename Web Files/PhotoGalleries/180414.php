  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "Hilda's 50th Birthday Party";
		$event_date = "04.14.2018";
		$fid = 60;
		
		//Zip Download
		$zip_name = "Hilda50.zip";
		$download_zip = "/images/2018.04.14/";
		
		//Download Image
		$download_img = "/images/2018.04.14/gallery/HD/";
