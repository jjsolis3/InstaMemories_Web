...
<body>
    ...
    <main>
        ...
        <section class="vl-hero-area vl-hero-bg p-relative fix z-index-1 pt-234 pb-100" style="background-image: url(./assets/img/banner/vl-hero-bg-3.png);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-5 mb-30">
                        ...
                        <div class="vl-hero-img-3 p-relative">
                            <img class="w-100" src="assets/img/banner/vl-hero-img-3.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-imgs vl-about-imgs-3 p-relative z-index-1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-about-large">
                                <img src="assets/img/about/vl-about-3.1.png" alt="">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            ...
                            <h2 class="vl-service-title pt-32"><a href="service-single.php">IT Consulting Services</a></h2>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                            ...
                            <h2 class="vl-service-title pt-32"><a href="service-single.php">IT Infrastructure Management</a></h2>
                    ...
                    <div class="col-lg-12 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1300">
                            <div class="vl-df">
                                <div class="vl-service-icon icon3">
                                    <span><img src="assets/img/icons/vl-service-ic-3.3.svg" alt=""></span>
                                </div>
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a href="service-single.php">Cybersecurity Services</a></h2>
                                    <p class="pt-16 pb-24">Protect your business from evolving cyber threats with our comprehensive cybersecurity solutions. From threat detection <br> and response to data encryption and compliance management, we safeguard your digital assets 24/7.</p>
                                    <a href="service-single.php" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1400">
                            <div class="vl-df">
                                <div class="vl-service-icon icon3">
                                    <span><img src="assets/img/icons/vl-service-ic-3.4.svg" alt=""></span>
                                </div>
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a href="service-single.php">Cloud Solutions</a></h2>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1500">
                            <div class="vl-df">
                                <div class="vl-service-icon icon3">
                                    <span><img src="assets/img/icons/vl-service-ic-3.5.svg" alt=""></span>
                                </div>
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a href="service-single.php">Software Development</a></h2>
                ...
                <div class="row">
                    <div id="gallery3" class="owl-carousel owl-theme">
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single.php">Efficiency Managed IT Services</a></h3>
                                    <p>Our solutions ensure availability,<br> minimal downtime, & improved.</p>
                                    <a href="case-studies-single.php" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single.php">Fortifying Cybersecurity</a></h3>
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single.php">Building Resilient Networks </a></h3>
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-img">
                                <img class="w-100" src="assets/img/studies/vl-case-studies-3.4.png" alt="">
                            </div>
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a href="case-studies-single.php">Efficiency Managed IT Services</a></h3>
        ...
        <section id="testimonial" class="vl-testimonial vl-testimonial-bg pt-100 pb-100" style="background-image: url(./assets/img/testimonial/vl-testimonial-bg-3.1.jpg);">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single.php">Discovery & Planning</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single.php">Design & Development</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1300">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single.php">Continuous Improvement</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a href="service-single.php">Launch & Support</a></h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="blog-single.php"><img class="br-8 w-100" src="assets/img/blog/vl-blog-3.1.png" alt=""></a>
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a href="blog-single.php">Revolutionize Your Operations <br> with Our Expertise</a></h3>
                                <a href="blog-single.php" class="vl-readmore more3">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1100">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="blog-single.php"><img class="br-8 w-100" src="assets/img/blog/vl-blog-3.2.png" alt=""></a>
                                <div class="vl-single-blog-tag">
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a href="blog-single.php">Empowering Your Business with <br> Cutting-Edge Insights</a></h3>
                                <a href="blog-single.php" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1300">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="blog-single.php"><img class="br-8 w-100" src="assets/img/blog/vl-blog-3.3.png" alt=""></a>
                                <div class="vl-single-blog-tag">
                                    <a href="#">It Service</a>
                                </div>
                            </div>
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a href="blog-single.php">Transform Your Business with <br> Innovative Solutions</a></h3>
                                <a href="blog-single.php" class="vl-readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
        ...
        <section id="cta" class="vl-cta">
            <div class="container">
                <div class="vl-cta-bg-1 vl-cta-bg-3 p-relative br-8" style="background-image: url(./assets/img/cta/cta-bg-3.1.jpg);">
                    <div class="row">
                        <div class="col-lg-9">
                        ...
                        <div class="col-lg-3 col-md-6 mb-30">
                            <div class="vl-hero-btn-3 fl-right">
                                <a href="contact.php" class="vl-btn-3">CONTACT US<span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row gx-2">
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="vl-footer-instapost p-relative z-index-1 fix mb-8">
                                        <img class="w-100" src="assets/img/footer/vl-ft-post-3.1.png" alt="">
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="vl-footer-instapost p-relative z-index-1 fix mb-8">
                                        <img class="w-100" src="assets/img/footer/vl-ft-post-3.2.png" alt="">
                                        <div class="vl-footer-instapost-icon">
                                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="vl-footer-instapost p-relative z-index-1 fix mb-8">
                                        <img class="w-100" src="assets/img/footer/vl-ft-post-3.3.png" alt="">
                                        <div class="vl-footer-instapost-icon">
                                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="vl-footer-instapost p-relative z-index-1 fix mb-8">
                                        <img class="w-100" src="assets/img/footer/vl-ft-post-3.4.png" alt="">
                                        <div class="vl-footer-instapost-icon">
                                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="vl-footer-instapost p-relative z-index-1 fix mb-8">
                                        <img class="w-100" src="assets/img/footer/vl-ft-post-3.5.png" alt="">
                                        <div class="vl-footer-instapost-icon">
                                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <div class="vl-footer-instapost p-relative z-index-1 fix mb-8">
                                        <img class="w-100" src="assets/img/footer/vl-ft-post-3.6.png" alt="">
                                        <div class="vl-footer-instapost-icon">
                                            <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
