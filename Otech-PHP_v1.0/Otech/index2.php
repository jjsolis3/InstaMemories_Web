...
<body>
    ...
    <main>
        ...
        <section class="vl-hero-area p-relative fix z-index-1 pt-200 pb-70" style="background-image: url(./assets/img/banner/vl-home-bg-2.png);">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 mb-30">
                        <div class="vl-hero-content p-relative z-index-1">
                            ...
                            <div class="vl-hero-btn">
                                <a href="contact.php" class="them-btn2 fix mr-16">Explore Solutions <span><i class="fa-regular fa-angle-right"></i></span></a>
                                <a href="contact.php" class="theme-sec-btn2">Contact Us<span><i class="fa-regular fa-angle-right"></i></span></a>
                    ...
                    <div class="col-xl-6 mb-30 p-relative">
                        <div class="vl-hero-half-circle">
                            <img src="assets/img/shape/vl-half-cicle-2.1.svg" alt="">
                        </div>
                        <div class="vl-hero-img--2 p-relative">
                            <img src="assets/img/banner/vl-bnr-2.1.png" alt="">
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-imgs-2 p-relative mr-60 aos-init aos-animate" data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-about-img--2">
                                <img src="assets/img/about/vl-about-2.1.png" alt="">
                            </div>
                            <div class="vl-about-img--2-1 d-none d-md-block">
                                <img src="assets/img/about/vl-about-2.2.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-content vl-home2-about aos-init aos-animate" data-aos="fade-left" data-aos-duration="900">
                            ...
                            <div class="vl-about-btn">
                                <a href="about.php" class="them-btn2">See my experience<span><i class="fa-regular fa-angle-right"></i></span></a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <div class="vl-service-content vl-service-content-2">
                            <div class="vl-service-icon vl-service-icon-2">
                                <span><img src="assets/img/icons/vl-service-ic-2.1.svg" alt=""></span>
                            </div>
                            ...
                            <a href="service-single.php" class="vl-readmore">Learn More <span><i class="fa-regular fa-angle-right"></i></span></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1200">
                        <div class="vl-service-content vl-service-content-2">
                            <div class="vl-service-icon vl-service-icon-2">
                                <span><img src="assets/img/icons/vl-service-ic-2.2.svg" alt=""></span>
                            </div>
                            <h2 class="vl-service-title pt-32"><a href="service-single.php">Software Development</a></h2>
                    ...
                    <div class="col-lg-5 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1400">
                        <div class="vl-service-content vl-service-content-2">
                            <div class="vl-service-icon vl-service-icon-2">
                                <span><img src="assets/img/icons/vl-service-ic-2.3.svg" alt=""></span>
                            </div>
                            <h2 class="vl-service-title pt-32"><a href="service-single.php">Cybersecurity Services</a></h2>
                    ...
                    <div class="col-lg-7 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1600">
                        <div class="vl-service-content vl-service-content-2">
                            <div class="vl-service-icon vl-service-icon-2">
                                <span><img src="assets/img/icons/vl-service-ic-2.4.svg" alt=""></span>
                            </div>
                ...
                <div id="gallery2" class="owl-carousel owl-theme">
                    ...
                    <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
                        ...
                        <div class="vl-gallery-poligon poligon2">
                            ...
                            <a href="case-studies-single.php"><span class="arow2"><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                        ...
                        <div class="vl-test-2-act">
                            ...
                            <div class="vl-test-flex">
                                <div class="vl-test-thumb">
                                    <img src="assets/img/testimonial/vl-testimonial-2.1.png" alt="">
                                </div>
                                <div class="vl-test-content">
                                    ...
                                    <div class="vl-test-aut">
                                        ...
                                        <div class="vl-test-aut-logo">
                                            <img src="assets/img/brand/vl-testimonial-brand-2.1.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="vl-test-flex">
                                <div class="vl-test-thumb">
                                    <img src="assets/img/testimonial/vl-testimonial-2.22.png" alt="">
                                </div>
                                <div class="vl-test-content">
                                    <div class="vl-test-icons">
                                        <ul>
                    ...
                    <div id="teamm2" class="owl-carousel owl-theme">
                        ...
                        <div class="vl-team-single text-center p-relative fix">
                            <div class="vl-team-single-image p-relative">
                                <div class="vl-team-single-image-shape">
                                    <img src="assets/img/shape/vl-team-shape.svg" alt="">
                                </div>
                                <img class="w-100" src="assets/img/team/vl-team-2.1.png" alt="">
                            ...
                            <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a href="team.php">Kendra Cremin</a></h4>
                        ...
                        <div class="vl-team-single text-center p-relative fix">
                            <div class="vl-team-single-image p-relative">
                                ...
                                <img class="w-100" src="assets/img/team/vl-team-2.2.png" alt="">
                                <div class="vl-team-single-image-social">
                                    <ul>
                                        <li><a href="#"><span><i class="fa-brands fa-facebook-f"></i></span></a></li>
                                        <li><a href="#"><span><i class="fa-brands fa-linkedin-in"></i></span></a></li>
                            ...
                            <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a href="team.php">Dennis Jacobson</a></h4>
                        ...
                        <div class="vl-team-single text-center p-relative fix">
                            <div class="vl-team-single-image p-relative">
                                ...
                                <img class="w-100" src="assets/img/team/vl-team-2.3.png" alt="">
                                <div class="vl-team-single-image-social">
                                    <ul>
                                        <li><a href="#"><span><i class="fa-brands fa-facebook-f"></i></span></a></li>
                                        <li><a href="#"><span><i class="fa-brands fa-linkedin-in"></i></span></a></li>
                            ...
                            <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a href="team.php">Patricia Wilkinson</a></h4>
                                <span>Network Engineer</span>
                            </div>
                        </div>
                        <!-- single team end -->
                            ...
                            <div class="vl-contact-wrap-icbox">
                                ...
                                <div class="vl-icon-box br-4 mb-20">
                                    <div class="vl-icon-box-icon mr-16">
                                        <span><img src="assets/img/icons/vl-call-2.1.svg" alt=""></span>
                                    </div>
                                ...
                                <div class="vl-icon-box br-4 mb-20">
                                    <div class="vl-icon-box-icon mr-16">
                                        <span><img src="assets/img/icons/vl-mail-2.2.svg" alt=""></span>
                                    </div>
                                    <div class="vl-icon-box-content">
                                ...
                                <div class="vl-icon-box br-4 mb-20">
                                    <div class="vl-icon-box-icon mr-16">
                                        <span><img src="assets/img/icons/vl-map-2.3.svg" alt=""></span>
                                    </div>
                                    <div class="vl-icon-box-content">
                    ...
                    <div class="col-lg-5">
                        <div class="vl-blog-content-2 mb-30 aos-init aos-animate" data-aos="fade-right data-aos-duration=" 900">
                            ...
                            <div class="vl-blog-btn">
                                <a href="blog.php" class="them-btn2">read more blog <span><i class="fa-regular fa-angle-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="vl-single-blog ml-60">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-5">
                                        <div class="vl-single-blog-img fix br-8">
                                            <a href="blog-single.php"><img class="br-8 w-100" src="assets/img/blog/vl-blog-1.1.png" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="vl-single-blog-content vl-single-blog-content-2">
                                            <h3 class="vl-single-blog-title vl-black-theme-2"><a href="blog-single.php">Your Trusted Partner in <br> Technology Transformation</a></h3>
                            ...
                            <div class="vl-single-blog-item vl-blg2 vl-gray-bg mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1300">
                                <div class="row align-items-center">
                                    <div class="col-lg-5">
                                        <div class="vl-single-blog-img fix br-8">
                                            <a href="blog-single.php"><img class="br-8 w-100" src="assets/img/blog/vl-blog-1.2.png" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="vl-single-blog-content vl-single-blog-content-2">
                                            <h3 class="vl-single-blog-title vl-black-theme-2"><a href="blog-single.php">Driving Success Through <br> Innovation and Collaboration</a></h3>
            ...
            <div class="container">
                <div class="vl-cta-bg-1 vl-cta-bg-2 p-relative fix br-8">
                    <div class="vl-cta-shape-2">
                        <img src="assets/img/shape/vl-cta-shape-2.1.svg" alt="">
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="vl-cta-wrapper mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                                ...
                                <div class="vl-cta-btn">
                                    <a href="blog.php" class="them-btn2">Start Your Journey<span><i class="fa-regular fa-angle-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="vl-footer-widget-1">
                            <div class="vl-footer-logo">
                                <a href="index.php"><img src="assets/img/logo/vl-logo-2.2.png" alt=""></a>
                            </div>
