  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "#Lilibeth's Graduation";
		$event_date = "06.06.2019";
		$path_date = "2019.06.06/";
		
		$fid = 2;
		
		//Zip Download
		$zip_name = "LilibethGrad.zip";
		$download_zip = "/images/";
		...
		//sql query
		$result = mysql_query("SELECT * FROM photography WHERE fid=\"{$fid}\" ORDER BY  `photography`.`id` ASC ");
