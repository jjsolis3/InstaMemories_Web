            ...
            <div class="container">
                ...
                <div class="vl-brand-inner-active">
                    ...
                    <div class="vl-brand-single-iner">
                        <img class="w-100" src="assets/img/brand/vl-brand-in-1.1.png" alt="">
                    </div>

                    <!-- single brand -->
                    <div class="vl-brand-single-iner">
                        <img class="w-100" src="assets/img/brand/vl-brand-in-1.2.png" alt="">
                    </div>

                    <!-- single brand -->
                    <div class="vl-brand-single-iner">
                        <img class="w-100" src="assets/img/brand/vl-brand-in-1.3.png" alt="">
                    </div>

                    <!-- single brand -->
                    <div class="vl-brand-single-iner">
                        <img class="w-100" src="assets/img/brand/vl-brand-in-1.4.png" alt="">
                    </div>

                    <!-- single brand -->
                    <div class="vl-brand-single-iner">
                        <img class="w-100" src="assets/img/brand/vl-brand-iner-1.5.png" alt="">
                    </div>
