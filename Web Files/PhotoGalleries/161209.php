...
<title>Insta-Memories | Under The Stars Holiday Party</title>
  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "Under The Stars Holiday Party";
		$event_date = "12.09.2016";
		$fid = 30;
		
		//Zip Download
		$zip_name = "UnderTheStars.zip";
		$download_zip = "/images/2016.12.09/";
		
		//Download Image
		$download_img = "/images/2016.12.09/gallery/HD/";
		
		//per page
		$per_page = 9;
		
		//sql query
		$result = mysql_query("SELECT * FROM gallery WHERE fid=\"{$fid}\"");
              	...
              	<h2><?php echo "$event_title  |  $event_date"; ?></h2>
					...
					<?php
						...
						for ($i = $start; $i < $end; $i++) {
						 ...
						 //echo"<tr><th><a href=\"" .$download_zip. "" .$zip_name. "\">Download All Pics</a></th></tr>";
