  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "Anna & Tony's Wedding";
		$event_date = "07.22.2017";
		$fid = 43;
		
		//Zip Download
		$zip_name = "AnnaTony.zip";
		$download_zip = "/images/2017.07.22/";
		
		//Download Image
		$download_img = "/images/2017.07.22/gallery/HD/";
