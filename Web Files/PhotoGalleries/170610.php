...
<title>Insta-Memories | Naydien's Graduation</title>
  ...
  <div class="body2">
    <div class="body3">
      <div class="main">
        ...
        <?php
		//Event Information
		$event_title = "Naydien's Graduation";
		$event_date = "06.10.2017";
		$fid = 40	;
		
		//Zip Download
		$zip_name = "NaydienGrad.zip";
		$download_zip = "../images/2017.06.10/";
		
		//Download Image
		$download_img = "../images/2017.06.10/gallery/HD/";
