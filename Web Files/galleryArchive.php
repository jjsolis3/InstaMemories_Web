...
<title>Insta-Memories | Gallery Archive</title>
<meta charset="utf-8">
      ...
      <div class="main">
        ...
        <div class="line1 wrapper">
            <div class="wrapper tabs">
 				...
 				<?php include_menu_template('eventListArchive.php'); ?>
				
				<!-- 2017 Event Pictures -->
                <?php include_menu_template('content2017.php'); ?>
                
                <!-- 2016 Event Pictures -->
                <?php include_menu_template('content2016.php'); ?>
                
                <!-- 2015 Event Pictures -->
                <?php include_menu_template('content2015.php'); ?> 
                
                <!-- 2014 Event Pictures -->
                <?php include_menu_template('content2014.php'); ?> 
              
             
				<!-- Corp Event Pictures -->   
                <?php include_menu_template('corpcontent2014.php'); ?>          
