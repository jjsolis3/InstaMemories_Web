...
define('MYSQL_NOT_EXISTS', create_error("Your PHP server doesn't have the MySQLi module loaded or you can't use mysqli_connect functions."));
...
*/
	...
	function Open()
	{
	  $this->connectionId = mysqli_connect($this->hostname, $this->username, $this->password);
		if (isset($this->connectionId) && $this->connectionId && ($this->connectionId instanceof mysqli))
		{
	...
	function Close()
	{
		if (($this->connectionId instanceof mysqli) && $this->isOpen)
		{
	...
	{
		$xmlOutput = "";
		if ($this->isOpen && isset($this->connectionId) && ($this->connectionId instanceof mysqli)){
			...
			if (($results instanceof mysqli_result) && mysqli_num_rows($results) > 0){
	...
	*/
	...
	function GetDatabaseList()
	{
		...
		if (isset($this->connectionId) && ($this->connectionId instanceof mysqli)){
